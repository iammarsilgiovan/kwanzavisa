    ...
    items: [
      {
        ...
        a: "Após submeter o pedido, receberá os dados de pagamento por referência (Entidade: 00930 / Referência: 935975173). O pagamento deve ser feito em Kwanzas (AOA) e confirmado antes do processamento.",
      },
      {
